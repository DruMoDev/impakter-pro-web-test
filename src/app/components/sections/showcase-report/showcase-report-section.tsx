  ...
  return (
    <section className="py-20">
      <div className="container flex flex-col gap-y-5">
        ...
        <div className="flex gap-9 justify-center items-center px-20 mt-5">
          <div className="flex flex-col justify-center items-center gap-5 p-12 text-center text-balance border shadow-sm rounded-2xl w-1/2">
            <Image
